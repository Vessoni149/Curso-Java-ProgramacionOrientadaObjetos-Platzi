...
public class Main {
        ...
        Doctor myDoctor = new Doctor(); //Doctor() es el llamado al metodo constructor, se compone de el
        // nombre de la clase y (). No hace falta declararlo ni importarlo acá. En nuestra clase Doctor
        ...
        myDoctor.showName();
        myDoctor.showId();
        //myDoctor es un objeto (instancia de la clase Doctor) y a atraves del objeto myDoctor llamamos
        // al metodo creado en la clase Doctor.
        //la segundda:
        ...
        Doctor doctor3 = new Doctor("Pedro Lopez", "pediatra");
        //Al crear la instancia solo hay que escribir los parametros, NO LOS TIPOS DE DATO, sino va a tirar error. Los tipos de
        ...
        myDoctorAnn.addAvailableAppointment(new Date(), "8pm");
                for (Doctor.AvailableAppointment aA: myDoctorAnn.getAvailableApponitments()){
                        System.out.println(aA.getDate() + " " + aA.getTime());
                }
    }
    /*Cuando asignamos un objeto a otro, es decir "objeto1 = objeto2", no es lo mismo que asignar una variable a otra.
    En el caso del objeto lo que sucede es que el objeto1 va a apuntar al espacio en memoria que esta ocupando el objeto2.
    Ambos objetos ahora van a apuntar al mismo lugar, entonces si imprimimos objeto1 y objeto2 van a mostrar los mismos datos.
